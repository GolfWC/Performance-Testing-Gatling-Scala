...
class Amex extends Simulation {
	...
	val scn = scenario("Amex")
		.exec(http("request_0")
			...
			.headers(headers_2)
			.body(RawFileBody("com/myGatlingTest/amex/0002_request.json")),
            http("request_3")
			.options(uri06)
			.headers(headers_3),
            http("request_4")
			...
			.post(uri06)
			.headers(headers_6)
			.body(RawFileBody("com/myGatlingTest/amex/0006_request.json")),
            http("request_7")
			...
			.post(uri08)
			.headers(headers_13)
			.body(RawFileBody("com/myGatlingTest/amex/0013_request.json")),
            http("request_14")
			...
			.headers(headers_15)
			.body(RawFileBody("com/myGatlingTest/amex/0015_request.json"))
			.check(status.is(401)),
            http("request_16")
			...
			.headers(headers_16)
			.body(RawFileBody("com/myGatlingTest/amex/0016_request.txt")),
            http("request_17")
			...
			.headers(headers_16)
			.body(RawFileBody("com/myGatlingTest/amex/0017_request.txt")),
            http("request_18")
			...
			.headers(headers_18)
			.body(RawFileBody("com/myGatlingTest/amex/0018_request.txt"))))
		.pause(1)
		.exec(http("request_19")
			...
			.headers(headers_16)
			.body(RawFileBody("com/myGatlingTest/amex/0020_request.txt")),
            http("request_21")
			.post(uri01 + "?ct=0")
			.headers(headers_21)
			.body(RawFileBody("com/myGatlingTest/amex/0021_request.txt")),
            http("request_22")
			...
			.headers(headers_16)
			.body(RawFileBody("com/myGatlingTest/amex/0028_request.txt")),
            http("request_29")
			...
			.body(RawFileBody("com/myGatlingTest/amex/0029_request.bin"))))
		.pause(3)
		.exec(http("request_30")
			...
			.headers(headers_30)
			.body(RawFileBody("com/myGatlingTest/amex/0030_request.txt"))
			...
			.headers(headers_30)
			.body(RawFileBody("com/myGatlingTest/amex/0031_request.txt"))))
